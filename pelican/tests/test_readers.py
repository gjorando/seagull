...
class RstReaderTest(ReaderTest):
    ...
    def test_article_metadata_key_lowercase(self):
        ...
        _, metadata = reader.read(_path("article_with_uppercase_metadata.rst"))
...
class MdReaderTest(ReaderTest):
    ...
    def test_article_with_file_extensions(self):
        ...
        # correct reader
        content, _ = reader.read(_path("article_with_mdown_extension.mdown"))
        expected = (
            "<h1>Test Markdown File Header</h1>\n<h2>Used for pelican"
            " test</h2>\n<p>This is another markdown test file.  Uses"
    ...
    def test_duplicate_tags_or_authors_are_removed(self):
        reader = readers.MarkdownReader(settings=get_settings())
        _, metadata = reader.read(_path("article_with_duplicate_tags_authors.md"))
        expected = {
            "tags": ["foo", "bar", "foobar"],
    ...
    def test_metadata_not_parsed_for_metadata(self):
        ...
        _, metadata = reader.read(_path("article_with_markdown_and_nested_metadata.md"))
        expected = {
